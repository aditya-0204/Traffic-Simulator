...
export function SimulationHistoryButton() {
  ...
  return (
    <button
      disabled={disabled}
      onClick={handleClick}
      className="text-sm font-semibold bg-gray-400 leading-6 items-center rounded-full flex py-2 px-4 mt-4 disabled:cursor-not-allowed disabled:bg-gray-300 disabled:text-gray-700"
    >
      History
    </button>
  );
